...
export default function PackageBookingForm({ data }) {
    ...
    return (
        <>
            ...
            <div className="">
                <h3 className="text-[2rem] mb-10">Delighted by <span className="text-sky-500">{data} package?</span> Get in Touch by Completing the Form Below.
                </h3>
                ...
                <div>
                    <div className="grid gap-5">
                        <div className="grid sm:gap-4 gap-3 mt-2">
                            ...
                            <input
                                className={`${errors.companyName ? 'border-1 border-red-500 w-full bg-sky-950 bg-opacity-30 backdrop-filter backdrop-blur-lg rounded-3 sm:p-6 p-5 placeholder-white' : 'border-0 w-full bg-sky-950 bg-opacity-30 backdrop-filter backdrop-blur-lg rounded-3 sm:p-6 p-5 placeholder-white'} `}
                                value={companyName}
